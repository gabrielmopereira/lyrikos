...
const sendWelcomeEmail = async (
  ...
  return sendEmail({
    ...
    subject: `Welcome to lyrikos${username ? `, ${username}` : ""}! Please verify your email`,
    tags: [
...
const sendSignUpAttemptEmail = async (
  ...
  return sendEmail({
    ...
    defaultReplyTo: config.defaultReplyTo,
    from: config.from || DEFAULT_FROM,
    subject: "Sign-up attempt with your lyrikos account",
    tags: [
...
const sendPasswordResetEmail = async (
  ...
  return sendEmail({
    ...
    defaultReplyTo: config.defaultReplyTo,
    from: config.from || DEFAULT_FROM,
    subject: "Reset your lyrikos password",
    tags: [
